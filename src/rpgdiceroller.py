...
def roll_dice():
    return """
a 'dice roller' that interprets a subset of [dice notation](https://en.wikipedia.org/wiki/Dice_notation).Two types of outputs depending on the second argument; verbose and summed.
```py
import re
import random
